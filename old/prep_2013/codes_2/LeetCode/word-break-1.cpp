...
/**
 * checks whether a word can be broken into dictionary words
 */
bool
Solution::_wordBreak(string s, unordered_set<string> &dict) {
        ...
        for (int i = 0; i < s.size(); ++i) {
                ...
                if (dict.find(prefix) != dict.end()) {
                        bool isSuffixBreakable = _wordBreak(s.substr(i+1, string::npos), dict);
                        if (isSuffixBreakable) {
                                memoized[s] = true;
                                return true;
                        }
                }
...
/**
 * Wrapper method; clears the map before using
 */
bool
